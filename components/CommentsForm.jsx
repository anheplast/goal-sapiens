...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4">Dejar una respuesta</h3>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Guarda mis datos para futuros comentarios.</label>
        </div>
      </div>
      {error && <p className="text-xs text-red-500">Todos los campos son obligatorios</p>}
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-green-500 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Publicar comentario</button>
